...
public class RenderView:UIView, ImageConsumer {
    ...
    var needReCreateDisplayFramebuffer = false
    ...
    public override func layoutSubviews() {
        ...
        if backingSize.width > 0
        {
            needReCreateDisplayFramebuffer = true
        }
    }
    ...
    public func newFramebufferAvailable(_ framebuffer:Framebuffer, fromSourceIndex:UInt) {
        ...
        if needReCreateDisplayFramebuffer
        {
            self.destroyDisplayFramebuffer()
            self.createDisplayFramebuffer()
            needReCreateDisplayFramebuffer = false
        }
